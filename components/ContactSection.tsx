        ...
        <div>
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-sm uppercase tracking-widest text-gray-500 font-bold">{t.nav.callDispatch}</p>
                <a href={`tel:${BRAND.contact.phone}`} className="text-2xl font-black hover:text-[var(--color-accent-cyan)] transition-colors">
                  {BRAND.contact.displayPhone}
                </a>
              </div>
            </div>
